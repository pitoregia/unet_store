...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our UNET Store!</h1>
           ...
           <footer class="footer">
               <div class="container">
               <center>
                   <p>Copyright &copy UNET Store. All Rights Reserved. | Contact Us: +6281296407617</p>
               </center>
               </div>
           </footer>
        </div>
